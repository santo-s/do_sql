...
/*
    ...
    "oracle" => array(
        "Type" => "Oracle",
        "DBLib" => "OracleOCI",
        "Database" => "192.168.0.9:1521/ORA920",
        "Host" => "",
        "Port" => "",
        "User" => "seven",
        "Password" => "seven",
...
//uicipe Connection Class @-A0F40029
class clsDBuicipe extends DB_Adapter
{
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["uicipe"]);
        parent::Initialize();
...
//End uicipe Connection Class

//oracle Connection Class @-C0BA3488
class clsDBoracle extends DB_Adapter
{
    function clsDBoracle()
    {
        $this->Initialize();
    }
